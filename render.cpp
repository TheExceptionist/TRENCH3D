...
void Render::drawWalls()
{
    ...
    for(int col = 0; col < m_display.getWidth(); col++)
    {
        //printf("Check 2\n");
        double plane_scalar = 2 * col / m_display.getWidth() - 1;
        ...
        int draw_start = -1*(window_height/2) + col_height/2;
        ...
        //printf("Draw Start: %d\n", draw_start);
        int draw_end = window_height/2 + col_height/2;
